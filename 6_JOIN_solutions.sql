-- These are my solutions of the Join Section of SQLZoo
...
SELECT player FROM goal JOIN game ON mdate
WHERE game.id = matchid AND game.stadium = 'National Stadium, Warsaw';
